...
A curated collection of hands-on DevOps projects for beginners to advanced practitioners.

## Projects

### [DevOps Home Lab 2025](https://github.com/Osomudeya/DevOps-Home-Lab-2025)
**Teaches:** Local development environment, Docker Compose, Kubernetes, monitoring, GitOps, and global deployment
...
**Teaches:** Terraform, CI/CD with GitHub Actions, Kubernetes, monitoring with Prometheus/Grafana, multi-environment infrastructure
**Who should do it:** Beginners to intermediate - focused on core DevOps tools and practices
